...
uniform sampler2D uMembraneTex; //teksturna jedinica
uniform sampler2D uCoverTex; //teksturna jedinica

uniform float uTime;

void main()
{
//	outCol = mix(texture(uMembraneTex, vec2(chTex.s, chTex.t)), texture(uCoverTex, vec2(chTex.s, chTex.t)), 0.5);
